...
| --- | --- | --- | --- | --- | --- |
| 1 | 2026-09-01 | [**What Multi-Agent Finance Should Actually Prove**](substack/01-what-multi-agent-finance-should-prove.md) | Understand the repository’s narrow claim: explicit ownership, discovery, structured contracts, inspectable flow, and source-set extensibility—not better predictions or returns. Meet Data User, Data Consultant, and Data Source as separate responsibilities. | Open the landing page, subscribe to the series, and star or bookmark the repository. | Responsibility map: User → Consultant → Source, coordinated by Plaza. |
